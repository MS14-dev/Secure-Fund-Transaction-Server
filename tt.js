...
//module.exports=encryptByDES;




var date=new Date().toString()
var date_encrypted= CryptoJS.DES.encrypt(date,'123456789') .toString()
console.log(date_encrypted)
var date_decrypted= CryptoJS.DES.decrypt(date_encrypted,'123456789') .toString()
console.log(date_decrypted)
